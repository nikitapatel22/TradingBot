...
if __name__ == "__main__":
    ...
    data = data.sort_values(by=["date"],
                            ascending=True)  # sorting the data according to date in ascending order to make it easy to devide data for training and testing.

    data.drop(['unix', 'symbol', 'Volume BTC', 'Volume USDT', 'high', 'low'], axis=1, inplace=True)
